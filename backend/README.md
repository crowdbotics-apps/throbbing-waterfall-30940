...
## Project Structure
    ...
    ├── throbbing_waterfall_30940  # Django project configurations
...
1. Clone this repo and `cd throbbing_waterfall_30940`
...
2. Clone this repo and `cd throbbing_waterfall_30940`
